...
class Ui_Dialog_about(object):
    def setupUi(self, Dialog_about):
        ...
        self.label_3.setStyleSheet(u"image: url(:/icons/autoJtag.png);")
    ...
    def retranslateUi(self, Dialog_about):
        Dialog_about.setWindowTitle(QCoreApplication.translate("Dialog_about", u"about AutoJtag", None))
        self.label_3.setText("")
        self.label.setText(QCoreApplication.translate("Dialog_about", u"<a href=\"www.autojtag.org\">AutoJtag</a>", None))
        self.label_2.setText(QCoreApplication.translate("Dialog_about", u"www.autojtag.org", None))
