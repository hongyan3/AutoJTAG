...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", u"AutoJtag v1 Designed by ZEEKR ZERO", None))
#if QT_CONFIG(tooltip)
        MainWindow.setToolTip("")
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(statustip)
        MainWindow.setStatusTip(QCoreApplication.translate("MainWindow", u"AutoJtag v1.0 ", None))
...
#endif // QT_CONFIG(tooltip)
        self.action_signalFuzz.setText(QCoreApplication.translate("MainWindow", u"Debug", None))
#if QT_CONFIG(tooltip)
        self.action_signalFuzz.setToolTip(QCoreApplication.translate("MainWindow", u"Debug", None))
#endif // QT_CONFIG(tooltip)
        self.action_send_data.setText(QCoreApplication.translate("MainWindow", u"Command", None))
#if QT_CONFIG(tooltip)
        self.action_send_data.setToolTip(QCoreApplication.translate("MainWindow", u"Send bus data", None))
#endif // QT_CONFIG(tooltip)
        self.action_dbcDecode.setText(QCoreApplication.translate("MainWindow", u"BSDL", None))
#if QT_CONFIG(tooltip)
        self.action_dbcDecode.setToolTip(QCoreApplication.translate("MainWindow", u"Import BSDL", None))
#endif // QT_CONFIG(tooltip)
